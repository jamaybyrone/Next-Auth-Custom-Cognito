...
import {ChangePasswordParams, useMemberStore} from '@/methods/hooks/store/useMemberStore'
import { useRouter } from 'next/navigation'
import {useFormik} from 'formik'
import {
  changePasswordFormikSchemaValues,
  changePasswordYupSchema,
  existingPasswordField, passwordConfirmationField, passwordField
...
const ChangePasswordLayout = () => {
  ...
  const handleSubmit = (values: ChangePasswordParams) => changePassword(values, router)
  ...
  return (
      <Card variant="outlined">
        ...
        >
          ...
          <Password {...passwordConfirmationField} formik={changePasswordFormik} />
